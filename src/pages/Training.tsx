...
const Training = () => {
  ...
  return (
    <section className="training-section py-5 bg-light" id="training">
      <Container>
        <TrainingHero />
        <h2 className="text-center text-dark mb-5">Our Training Programs</h2>
        ...
        <Row className="align-items-center mb-5">
          <Col lg={6} className="text-center text-lg-start mb-4 mb-lg-0">
            ...
            <p className="text-muted fs-5 mb-4">
              ...
              systems (CMS) like Strapi to help you manage dynamic content efficiently. This
              course is perfect for those who want to master the tools to create robust and
              scalable websites.
            </p>
            <Button
              variant="warning"
        ...
        <Row className="align-items-center mb-5 flex-lg-row-reverse">
          <Col lg={6} className="text-center text-lg-start mb-4 mb-lg-0">
            <h3 className="text-warning mb-3">Graphic Design</h3>
            <p className="text-muted fs-5 mb-4">
        ...
        <Row className="align-items-center mb-5">
          <Col lg={6} className="text-center text-lg-start mb-4 mb-lg-0">
            <h3 className="text-warning mb-3">Python Data Analysis</h3>
            <p className="text-muted fs-5 mb-4">
